...
git fetch https://github.com/LineageOS/android refs/changes/08/392208/2 && git cherry-pick FETCH_HEAD; \
repo sync -f LineageOS/android_external_sonivox; \
git fetch https://github.com/LineageOS/android_external_sonivox refs/changes/09/392209/1 && git cherry-pick FETCH_HEAD; \
git fetch https://github.com/LineageOS/android_frameworks_base refs/changes/07/392207/1 && git cherry-pick FETCH_HEAD; \
git fetch https://github.com/LineageOS/android_frameworks_base refs/changes/06/392206/1 && git cherry-pick FETCH_HEAD; \
